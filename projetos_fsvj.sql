...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18/06/2025 às 16:48
...
(1, 'asdsadasdasd', '', 'NÃO INICIADA', '2025-06-02', '2025-06-04', 1),
(4, 'asdsadasdasd', '', 'NÃO INICIADA', '2025-06-02', '2025-06-04', 11);
...
--
ALTER TABLE `usuarios_projetos`
  MODIFY `ID_USUARIO_PROJETO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `fases`
  ADD CONSTRAINT `FK_FASES_PROJETOS` FOREIGN KEY (`ID_PROJETO`) REFERENCES `projetos` (`ID_PROJETO`) ON DELETE CASCADE;
...
--
ALTER TABLE `tarefas`
  ADD CONSTRAINT `FK_TAREFAS_FASES` FOREIGN KEY (`ID_FASE`) REFERENCES `fases` (`ID_FASE`) ON DELETE CASCADE,
...
--
ALTER TABLE `usuarios_projetos`
  ADD CONSTRAINT `FK_USUARIOS_PROJETOS_PROJETOS` FOREIGN KEY (`ID_PROJETO`) REFERENCES `projetos` (`ID_PROJETO`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_USUARIOS_PROJETOS_USUARIOS` FOREIGN KEY (`ID_USUARIO`) REFERENCES `usuarios` (`ID_USUARIO`) ON DELETE CASCADE;

--
-- Restrições para tabelas `usuarios_tarefas`
--
ALTER TABLE `usuarios_tarefas`
  ADD CONSTRAINT `FK_USUARIOS_TAREFAS_TAREFAS` FOREIGN KEY (`ID_TAREFA`) REFERENCES `tarefas` (`ID_TAREFA`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_USUARIOS_TAREFAS_USUARIOS` FOREIGN KEY (`ID_USUARIO`) REFERENCES `usuarios` (`ID_USUARIO`) ON DELETE CASCADE;
COMMIT;
