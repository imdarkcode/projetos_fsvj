<?php
    ...
    while ($row_projeto = $query_projeto -> fetch_assoc()) {
        ...
        $sql = "SELECT U.NOME, U.HIERARQUIA FROM PROJETOS P INNER JOIN USUARIOS_PROJETOS UP ON P.ID_PROJETO = UP.ID_PROJETO INNER JOIN USUARIOS U ON UP.ID_USUARIO = U.ID_USUARIO WHERE P.ID_PROJETO = '$id_projeto'";
